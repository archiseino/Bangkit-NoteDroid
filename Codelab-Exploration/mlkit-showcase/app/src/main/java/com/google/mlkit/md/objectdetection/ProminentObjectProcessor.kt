...
class ProminentObjectProcessor(
  ...
  private val customModelPath: String? = null) :
    ...
    override fun onSuccess(
        ...
        /**
         * Probably about the custom view when the Retcile has not on the object but has already detected
         * */
        val objectIndex = 0
        ...
        if (!hasValidObjects) {
            ...
            val reticleOverlap = objectBoxOverlapsConfirmationReticle(graphicOverlay, visionObject)
